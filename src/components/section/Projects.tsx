...
const Projects = () => {
  ...
  {
    title: "Xuxemons",
    description: "A gamified web app where players collect creatures, feed them to level up, manage their inventory, and battle other players in real time.",
    technologies: ["Angular", "Laravel", "MySQL", "Docker", "JWT"],
    icon: comingSoon,
    detailsUrl: "/projects/xuxemons",
    githubUrl: socialLinks.repositories.projectOne
  },
  {
    title: "StudyPlan",
    description: "A smart study planning web app that automatically organizes schedules, tasks and deadlines — designed for vocational training students.",
    technologies: ["React", "Node.js", "MySQL"],
    icon: comingSoon,
    detailsUrl: "/projects/studyplan",
