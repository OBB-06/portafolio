  ...
  const experiences = [
    {
      ...
      description: [
        "Provide technical support to users, resolving software and network incidents.",
        "Collaborate with infrastructure teams for the implementation of updates and security patches.",
        "Reduce recurrent incidents through proactive troubleshooting.",
      ],
    },
  ];
